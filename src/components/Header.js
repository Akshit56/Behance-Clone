...
// //         <div className='top-header py-4 px-5 border-b border'>
// //           <div className='navbar flex items-center'>
// //           <div className='brand-logo'>
// //             <img src = {behance_logo} alt = {behance_logo} className='w-auto h-4' />
// //           </div>
// //           <div className='page-links ml-10'>
// //             <ul className='flex itmes-center'>
// //               <li className='mx-4 font-medium'><a href = "http://" target = "_" rel = "_">Explore</a></li>
// //               <li className='mx-4 font-medium'><a href = "http://" target = "_" rel = "_">Assets</a></li>
// //               <li className='mx-4 font-medium'><a href = "http://" target = "_" rel = "_">Jobs</a></li>
// //               <li className='mx-4 font-medium'><a href = "http://" target = "_" rel = "_">Behance</a></li>
// //               <li className='mx-4 font-medium'><a href = "http://" target = "_" rel = "_">Jobs</a></li>
// //             </ul>
// //           </div>
// //           <div className='action-area'>
// //             <div className='login-btn'><a href = "google.com">Login</a></div>
// //           </div>
// //             <div className='login-btn'><a href = "google.com">Sign up</a></div>
// //           </div>
// //           <span></span>
// //           </div>
...
const Header = () => {
    ...
    useEffect(() => {
        // Example suggestions, replace with your data fetching logic
        setSuggestions(["project", "portfolio", "design", "art", "illustration", "graphic", "animation", "UI/UX", "photography"]);
    }, []);
                                ...
                                <div className="search-box w-full border-2 rounded-full bg-[#f9f9f9] overflow-hidden flex items-center justify-between">
                                    <div className="input-box relative lg:w-full">
                                        ...
                                        {filteredSuggestions.length > 0 && (
                                            <div className="autocomplete-dropdown absolute bg-white border mt-2 w-full rounded-lg shadow-lg">
